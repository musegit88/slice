...
import CatgoryUpload from "@/components/cloudinary-upload";
import { useState } from "react";
import ChevronDown from "@/components/ui/icons/chevron-down";
import ChevronUp from "@/components/ui/icons/chevron-up";
...
const MenusForm = ({ filteredCategory }) => {
  ...
  return (
    <>
      ...
      <div className="grid">
        <CatgoryUpload link={link} setLink={setLink} imageError={imageError} />
          ...
          <div>
            ...
            >
              ...
              {opened && (
                <div
                  className={cn(
                    "absolute mt-3 max-h-60 w-full left-0 overflow-auto rounded-md bg-white py-1 text-base shadow-lg overflow-hidden",
                    opened
